...
public function passwordUpdate(Request $request)
{
    $request->validate([
        ...
        'password' => 'required|min:5|confirmed', // This validates the 'password' field
    ]);
    ...
    // Use the correct field for the new password
    $admin->update([
        'password' => Hash::make($request->password) // Ensure you're hashing the 'password' input
    ]);
