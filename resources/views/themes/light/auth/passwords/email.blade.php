...
@section('title', 'Password Reset on Jeemo.io')
@section('content')
            ...
            <div class="col-xl-5 col-md-6 order-2 order-md-1">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="php-email-form">
                    ...
                    <div class="login-signup-header">
                        ...
                        <div class="description">@lang('Enter a registered email address to reset your password on Jeemo.io')</div>
                    </div>
                    <div class="row g-3">
                        <div class="col-12">
                    ...
                    <button type="submit" class="btn cmn-btn mt-30 w-100">@lang('Reset') </button>
                </form>
