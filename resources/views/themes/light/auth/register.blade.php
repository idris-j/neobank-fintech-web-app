...
@section('title',trans('Open an account on Jeemo.io'))
@section('content')
                ...
                <div class="login-signup-form">
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="position-relative"> <!-- Wrapper for positioning -->
                                    ...
                                    <i class="fa-regular fa-info-circle"
                                       ...
                                       title="Your username would be used as Jeemo.io tag to send and receive funds between other Jeemo.io users"></i>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" name="country_code" id="countryCode" value="{{ old('country_code') ?? 'ng' }}"/>
                            </div>
                            @error('phone')
                        ...
                        <button id="signupBtn" type="submit" class="btn cmn-btn mt-30 w-100">@lang('Open account')</button>
